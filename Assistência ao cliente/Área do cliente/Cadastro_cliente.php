...
if(isset($_POST['usuario'])){
  ...
  $query = "SELECT * FROM login_cliente WHERE usuario = '$usuario'";
  ...
  if(strlen($_POST['usuario']) == 0){
    ...
    $mysqli->query("INSERT INTO login_cliente (nome_Completo, usuario, senha) VALUES ('$nome_completo', '$usuario', '$senha')");
  }
